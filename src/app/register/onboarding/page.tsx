...
export default function OnboardingPage() {
  ...
  const handleSubmit = async (e?: React.FormEvent | React.MouseEvent) => {
    ...
    if (!linkedinUrl.trim()) nextErrors.linkedinUrl = "LinkedIn profile URL is required.";
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="linkedinUrl" className="block text-[13px] font-bold uppercase tracking-wider text-fg-2 mb-1.5">
                LinkedIn Profile URL <span className="text-destructive font-normal">*</span>
              </label>
              <input
                id="linkedinUrl"
                type="url"
              ...
              {fieldErrors.linkedinUrl && (
                <p className="mt-1 text-[13px] text-destructive font-medium">{fieldErrors.linkedinUrl}</p>
              )}
            </div>
