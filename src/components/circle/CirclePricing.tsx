    ...
    >
      ...
      {highlighted && (
        <div className="mt-4">
          ...
          <p className="mb-2 font-bold uppercase" style={{ fontSize: "var(--text-micro)", letterSpacing: "0.0354294em", color: "var(--fg-3)" }}>
            Plus, exclusively:
          </p>
