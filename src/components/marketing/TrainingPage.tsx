...
import ProgramsGrid from "@/components/home/AcceleratorTeaser";
...
const trainingSteps: TrainingStep[] = [
  ...
  {
    label: "Deliver",
    description: ["Practice on real work with a", "clear clarity on what AI can do."],
  },
];
...
export default function TrainingPage() {
  return (
    <main id="main" className="flex-1 pt-24">
      <section className="relative overflow-hidden bg-surface-dark" style={{ padding: "clamp(76px, 10vw, 148px) var(--section-px) clamp(64px, 8vw, 104px)" }}>
        <div className="mx-auto grid max-w-7xl gap-10 xl:grid-cols-[minmax(0,1fr)_minmax(20rem,0.5fr)] xl:items-center xl:gap-12">
          <div className="max-w-3xl">
            ...
            <div className="mt-8">
              <TrackedBookingButton intent="training" variant="solid" tone="green">
                Plan a team session
      ...
      <AiosFaq faqs={trainingFaqs} heading="Questions teams ask before they plan a session." />
      <FinalCta
