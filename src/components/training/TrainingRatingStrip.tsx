...
export default function TrainingRatingStrip() {
  return (
    <section className="bg-bg" aria-label="Training feedback" style={{ padding: "0 var(--section-px) var(--section-py)" }}>
      <div className="mx-auto flex max-w-7xl flex-col gap-7 border-y border-emerald/15 bg-surface-accent-soft px-6 py-8 sm:flex-row sm:items-center sm:justify-between sm:gap-10 sm:px-8 sm:py-9">
        <div>
        ...
        <div
          className="relative inline-flex w-fit rotate-[-2deg] items-center gap-3 self-start border-2 border-emerald bg-surface-light px-4 py-3 text-emerald shadow-card before:absolute before:-left-1 before:-top-1 before:size-2 before:rounded-full before:bg-emerald after:absolute after:-bottom-1 after:-right-1 after:size-2 after:rounded-full after:bg-emerald sm:self-auto"
